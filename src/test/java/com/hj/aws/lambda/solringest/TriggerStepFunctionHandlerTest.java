 ...
 */
public class TriggerStepFunctionHandlerTest {
    ...
    @Test
    public void testTriggerStepFunctionHandler() {
        TriggerStepFunctionHandler handler = new TriggerStepFunctionHandler();
