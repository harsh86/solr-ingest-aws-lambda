 ...
 */
public class DownloadMetricEventLambdaFunctionHandlerTest {
  ...
  @Test
  public void testSolrInjestLambdaFunctionHandler() {
    DownloadMetricEventLambdaFunctionHandler handler = new DownloadMetricEventLambdaFunctionHandler();
